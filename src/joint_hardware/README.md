...
60FFh unit. The mechanical velocity limit remains 360 rpm (0.020 m/s), and
...
clamped to `[-1.0, 0.0] m` and the outer loop never exceeds 360 rpm (0.020 m/s).
...
0.020 m/s mechanical limit. A positive `acc` can tighten, but never raise, the
